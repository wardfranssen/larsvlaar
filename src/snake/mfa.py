...
def generate_code(user_id: str, email: str) -> str:
    code = f"{random.choice(['#', ''])}{random.choice([random.choice(main.boodschappen_lijstje).upper(), random.choice(main.boodschappen_lijstje).lower(), random.choice(main.boodschappen_lijstje)])}{random.choice(numbers)}"
